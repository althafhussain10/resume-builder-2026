  ...
  <div className="p-6 text-[10px]" style={{ fontFamily: "Verdana, sans-serif" }}>
    ...
    <div className="grid grid-cols-[1fr_180px] gap-4">
      <div>
        ...
        {data.experience.map(e => (<div key={e.id} className="mb-3"><p className="font-bold text-[10px]">{e.position} <span className="font-normal text-gray-400">@ {e.company}</span></p><p className="text-[9px] text-red-600">{e.startDate} - {e.endDate}</p><SummaryText text={e.description} className="text-gray-600 mt-0.5" /></div>))}
